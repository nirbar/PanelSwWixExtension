...
$dummy = $project.ProjectItems.Item("PanelSwWixExtension.DummyFile.txt").Delete()
...
$hintPath = Resolve-Path ($toolsPath + '\lib\PanelSwWixExtension.dll') -Relative

Pop-Location 

#    <WixExtension Include="PanelSwWixExtension">
#      <HintPath>..\..\Libs\PanelSwWixExtension\PanelSwWixExtension.dll</HintPath>
#      <Name>PanelSwWixExtension</Name>
#    </WixExtension>

$metadata = New-Object 'System.Collections.Generic.Dictionary[String, String]'
$metadata.Add("HintPath", $hintPath)
$metadata.Add("Name", "PanelSwWixExtension")
$itemGroup.AddItem('WixExtension', 'PanelSwWixExtension', $metadata)
