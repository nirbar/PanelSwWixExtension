...
namespace PanelSw.Wix.Extensions
{
    public sealed class PanelSwWixExtension : BaseExtensionFactory
    {
        ...
        public static XNamespace Namespace => XNamespace.Get("http://schemas.panel-sw.co.il/wix/WixExtension");

        private static List<TableDefinition> _tableDefinition;
        public static IReadOnlyCollection<TableDefinition> TableDefinitions
        {
            get
            {
