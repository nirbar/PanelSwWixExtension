    ...
    internal class PSW_ForceVersion : BaseSymbol
    {
        ...
        public static IEnumerable<ColumnDefinition> ColumnDefinitions
        {
            get
            {
                ...
                {
                    new ColumnDefinition(nameof(File), ColumnType.String, 72, true, false, ColumnCategory.Identifier, modularizeType: ColumnModularizeType.Column, keyTable: "Directory", keyColumn: 1)
